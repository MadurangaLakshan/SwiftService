...
export async function getBookingDetails(req: AuthRequest, res: Response) {
  try {
...
export async function getProviderBookings(req: AuthRequest, res: Response) {
  try {
...
export async function getSingleBooking(req: AuthRequest, res: Response) {
  try {
...
export async function updateBookingStatus(req: AuthRequest, res: Response) {
  try {
    ...
    try {
      ...
      const notifyUserId = isProvider ? booking.customerId : booking.providerId;
...
export async function approveCompletedWork(req: AuthRequest, res: Response) {
  try {
    const { bookingId } = req.params;
...
export async function rejectCompletedWork(req: AuthRequest, res: Response) {
  try {
    const { bookingId } = req.params;
...
export async function updateWorkDocumentation(req: AuthRequest, res: Response) {
  try {
    const { bookingId } = req.params;
